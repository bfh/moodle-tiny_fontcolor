...
$string['usefortable'] = 'Use colors for the table border and cell background';
$string['usefortable_desc'] = 'When enabled, the table also uses the defined colors by this plugin. Text colours can be used as border colors, background colours likewise. In the context menu of the table two new buttons appear to choose border and background colours respectively. In the table properties advanced settings, only the hardcoded color picker remains.';
