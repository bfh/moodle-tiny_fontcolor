...
$string['tinytextbackgroundcolors_desc'] = 'A comma separated list of alternately RGB color code and text string, e.g. "#000000,Black,#ffffff,White". The values become the text background colors to choose from.';
$string['tinytextcolors'] = 'Available text colors';
$string['tinytextcolors_desc'] = 'A comma separated list of alternately RGB color code and text string, e.g. "#000000,Black,#ffffff,White". The values become the text colors to choose from.';
